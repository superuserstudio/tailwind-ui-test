import { Image as ImageIcon, UserCircle as UserCircleIcon } from 'lucide-react';
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                <UserCircleIcon className="size-12 text-gray-300" aria-hidden="true" />
                <button
                  type="button"
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                <div className="text-center">
                  <ImageIcon className="mx-auto size-12 text-gray-300" aria-hidden="true" />
